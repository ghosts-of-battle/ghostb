/*
Function: ghostb_fnc_AddSelfAction
...
if (player != _player) exitWith {
 [
  ...
  _condition,
  _removeCompleted
 ] remoteExec ["ghostb_fnc_AddSelfAction", _player];
};
...
if (isClass (configFile >> "CfgPatches" >> "ace_main")) then {
 ...
 _condition = [_condition, "_player", "_this", nil, false] call ghostb_fnc_FindReplaceString;
