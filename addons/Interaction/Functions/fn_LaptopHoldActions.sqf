/*
Function: ghostb_fnc_LaptopHoldActions
...
Examples:
    (begin example)
        [this] call ghostb_fnc_LaptopHoldActions;
  [MyLaptopName] call ghostb_fnc_LaptopHoldActions;
  [this, "Download the Intel"] call ghostb_fnc_LaptopHoldActions;
  [this, "Trigger the Alarm", 5, "A3\Sounds_F\sfx\alarm_blufor.wss"] call ghostb_fnc_LaptopHoldActions;
    (end)
...
//  playSound3D [((_this select 2) select 3), _Newobject, false, getposATL _Newobject, 1, 1, 200];
  [_Newobject, (_this select 2) select 3, (_this select 2) select 4, (_this select 2) select 5] call ghostb_fnc_Sound3D;
//  [_Newobject, "AirRaid"] call ghostb_fnc_Sound3D;
 },
 ...
 "Processing",
 false
] remoteExec ["ghostb_fnc_AddHoldAction", 0, _object];
