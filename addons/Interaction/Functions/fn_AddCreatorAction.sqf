/*
Function: ghostb_fnc_AddCreatorAction
...
if (!GHOSTB_CreatorActions_Master) exitWith {};
...
[
 "ghostb_RegisterCreatorAction", [_action, _actionPath, _actionName], format["ghostb_CAJIP_%1", _actionName]
