/*
Function: ghostb_fnc_AddHoldAction
...
if (_global) exitWith {
 [
  ...
  _progressTitle,
  false
 ] remoteExec ["ghostb_fnc_AddHoldAction", 0, _id];
};
...
if (isClass (configFile >> "CfgPatches" >> "ace_main")) then {
 ...
 _conditionShow = [_conditionShow, "_player", "_this", nil, false] call ghostb_fnc_FindReplaceString;
 _conditionProgress = [_conditionProgress, "_player", "_this", nil, false] call ghostb_fnc_FindReplaceString;
