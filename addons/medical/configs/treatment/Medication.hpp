...
class GHOSTB_Apap: PainKillers {
    painReduce=0.2;
    timeInSystem=450;
    maxDose=15;
    inCompatableMedication[]={};
};
class GHOSTB_Apap_half: GHOSTB_Apap {
    painReduce=0.1;
};
class GHOSTB_Apap_quarter: GHOSTB_Apap {
    painReduce=0.05;
};
class GHOSTB_Apap_nil: GHOSTB_Apap {
    painReduce=0;
};
