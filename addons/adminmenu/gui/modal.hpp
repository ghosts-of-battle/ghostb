class GVAR(modal) {
    ...
    class Controls {
        class Background: RscText {
            idc = IDC_GHOSTB_ADMINMENU_MODAL_BACK;
        ...
        class TitleBackground: RscText {
            idc = IDC_GHOSTB_ADMINMENU_MODAL_TBACK;
        ...
        class Title: RscTitle {
            idc = IDC_GHOSTB_ADMINMENU_MODAL_TITLE;
            text = "GHOSTB Admin Menu";
            style = 0;
            colorBackground[] = {0, 0, 0, 0};
            x = "1.5 * (((safezoneW / safezoneH) min 1.2) / 40) + (safezoneX + (safezoneW - ((safezoneW / safezoneH) min 1.2))/2)";
            y = "2.6 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        ...
        class GroupBackground: RscText {
            idc = IDC_GHOSTB_ADMINMENU_MODAL_GBACK;
        ...
        class Group: RscControlsGroup {
            idc = IDC_GHOSTB_ADMINMENU_G_MODAL;
        ...
        class Close {
            idc = IDC_GHOSTB_ADMINMENU_MODAL_CLOSE;
            type = 1;
            style = "48 + 2048";
