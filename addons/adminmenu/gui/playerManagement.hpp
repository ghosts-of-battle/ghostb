class Controls {
    ...
    class ComboFilterSide: RscCombo {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_FILTER_SIDE;
        sizeEx = "GHOSTB_ADMINMENU_STD_SIZEX";
    ...
    class ComboFilterState: ComboFilterSide {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_FILTER_STATE;
        x = "8.3 * (((safezoneW / safezoneH) min 1.2) / 40)";
        w = "5 * (((safezoneW / safezoneH) min 1.2) / 40)";
    };
    class ButtonFilterReset: GVAR(RscButtonMenu) {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_FILTER_RESET;
        text = "Reset";
    ...
    class ButtonRefresh: GVAR(RscButtonMenu) {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_REFRESH;
        text = "Refresh";
    ...
    class BackgroundGroupList: RscText {
        ...
        w = "GHOSTB_ADMINMENU_PMAN_W_LISTGROUP";
        h = "GHOSTB_ADMINMENU_PMAN_H_LISTGROUP";
        colorBackground[] = {0, 0, 0, 0.3};
        style = "0x02";
    };

    class ListPlayers: RscListBox {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_LIST;
    ...
    */
    ...
    class ButtonSelectAll: ButtonFilterReset {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_SEL_ALL;
        text = "All";
        x = "30.9 * (((safezoneW / safezoneH) min 1.2) / 40)";
        y = "1.1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
        w = "6.9 * (((safezoneW / safezoneH) min 1.2) / 40)";
    ...
    class ButtonSelectNone: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_SEL_NONE;
        text = "None";
    ...
    class ButtonSelectInvert: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_SEL_INVERT;
        text = "Invert";
    ...
    //     idc = IDC_GHOSTB_ADMINMENU_PMAN_ACRELANGUAGES;
    ...
    //     idc = IDC_GHOSTB_ADMINMENU_PMAN_ACRERADIOS;
    //     text = "ACRE2 Radios";
    ...
    //     idc = IDC_GHOSTB_ADMINMENU_PMAN_ASSIGNGEAR;
    //     text = "Assign Gear";
    ...
    class ButtonAssignTraits: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_ASSIGNTRAITS;
        text = "Assign Traits";
    ...
    class ButtonGrantZeus: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_GRANTZEUS;
        text = "Grant Zeus";
    ...
    class ButtonHeal: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_HEAL;
        text = "Heal";
    ...
    class ButtonMessage: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_MESSAGE;
        text = "Message";
    ...
    class ButtonQuickRespawn: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_QRESPAWN;
        text = "Quick Respawn";
    ...
    class ButtonRunCode: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_RUNCODE;
        text = "Run Code On";
    ...
    class ButtonSteamProfile: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_STEAM;
        text = "Steam Profile";
    ...
    class ButtonTeleport: ButtonSelectAll {
        idc = IDC_GHOSTB_ADMINMENU_PMAN_TELEPORT;
        text = "Teleport";
