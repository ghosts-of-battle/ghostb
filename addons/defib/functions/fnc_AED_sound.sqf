...
if !(_caller getVariable ["ghostb_defib_soundplayed", false]) then {
    _caller setVariable ["ghostb_defib_soundplayed", true, true];
    _args spawn {
        ...
        sleep 1.5;
        if !(_caller getVariable ["ghostb_defib_soundplayed", false]) exitWith {};
        ...
        _caller setVariable ["ghostb_defib_soundplayed", false, true];
    };
};
