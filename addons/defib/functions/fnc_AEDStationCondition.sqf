 ...
 *
 * Example:
 * [player, cursorObject] call ghostb_defib_fnc_AEDStationCondition
 *
 * Public: No
 */
...
{
    if (typeOf _x isEqualTo "ghostb_defib_AEDItem" || typeOf _x isEqualTo "Land_Defibrillator_F") then {
